...
class DJ:
    ...
    trackBloodhoundGang = Track("The Bad Touch", 'music/boodhound.ogg')
    ...
    trackYvesLarock = Track("My dram is to fly over the rainbow so high", 'music/larock.ogg')
    ...
    trackRasputin = Track("Love The Way You Move", 'music/rasputin.ogg')
